...
and employees with user account and authorization to check 
rotas and apply for PTO which would be shown in an available 
calendar as either requested, Accepted, Denied. This would 
automatically feed back into the data for availability of staff to 
update auto rota generation for available staff for a given week 
